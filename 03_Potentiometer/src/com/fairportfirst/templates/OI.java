...
public class OI {
    ...
    public OI() {
        //button.whilePressed(new CathodePotentiCommand());
        //uncomment to make run while trigger is held.
    }
    ...
    public static double getPotentiValue() {
        return CommandBase.potentiSubsystem.getValue();
    }
