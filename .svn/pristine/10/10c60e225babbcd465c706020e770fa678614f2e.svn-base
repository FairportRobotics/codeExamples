...
import com.fairportfirst.templates.subsystems.*;
...
public abstract class CommandBase extends Command {
    ...
    public static PotentiometerSubsystem potentiSubsystem = PotentiometerSubsystem.getInstance();
    public static CathodeSubsystem cathodeSubsystem = CathodeSubsystem.getInstance();
